...
public class CombateJugador : MonoBehaviour
{
    ...
    private Queue<float> bufferEntradas = new Queue<float>();
    ...
    private void Atacar()
    {
        ...
        soundController?.playAtaque(); // 🔊 Seguro, sin error de acceso
    ...
    {
        return ataqueActual.tipoDeAtaque switch
        {
    ...
    private void ResetearCombo() => indiceCombo = 0;
